...
function StationDetails({ userId, user, analyzers, setAnalyzers, station, setStation }) {
    ...
    const [editDescription, setEditDescriptions] = useState(station?.find(value => value._id === stationId?.stationId)?.description);
