      ...
      <NavBar user={user} />
        {
          ...
          <Routes>
            ...
            <Route path='/stationDetails/:stationId' element={<StationDetails userId={user?._id}  user={user} analyzers={analyzers} setAnalyzers={setAnalyzers} station={station} setStation={setStation}/> }/>
